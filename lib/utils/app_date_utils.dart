...
extension DateTimeExtension on DateTime {
  ...
  String toDateTimeString({String format = AppConfigs.dateTimeFormat}) {
    try {
  ...
  String toTimeDisplay({String format = AppConfigs.timeDisplay}) {
    try {
      return DateFormat(format).format(this);
    } catch (e) {
      return '';
  ...
  String toDateTimeAPIString({String format = AppConfigs.dateTimeFormat}) {
    try {
