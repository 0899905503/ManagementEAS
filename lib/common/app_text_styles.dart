...
class AppTextStyle {
  ...
  static final blackS18Bold = blackS18.copyWith(fontWeight: FontWeight.w600);
  static final blackS18W800 = blackS18.copyWith(fontWeight: FontWeight.w800);

  //s20
  static final blackS20 = black.copyWith(fontSize: 20);
  static final blackS20Bold = blackS20.copyWith(fontWeight: FontWeight.w600);
  static final blackS20Medium = blackS20.copyWith(fontWeight: FontWeight.w500);
  static final blackS20W800 = blackS20.copyWith(fontWeight: FontWeight.w800);

  //s22
  static final blackS22 = black.copyWith(fontSize: 22);
  static final blackS22Bold = blackS22.copyWith(fontWeight: FontWeight.w700);
  static final blackS22W800 = blackS22.copyWith(fontWeight: FontWeight.w800);

//26
  //s18
  static final blackS26 = black.copyWith(fontSize: 26);
  static final blackS26Bold = blackS26.copyWith(fontWeight: FontWeight.w700);
  static final blackS26W800 = blackS26.copyWith(fontWeight: FontWeight.w800);

  static const red = TextStyle(color: Colors.red);

  //s12
  static final redS12 = red.copyWith(fontSize: 12);
  static final redS12Bold = redS12.copyWith(fontWeight: FontWeight.w700);
  ...
  static final whiteS18W800 =
      whiteS18.copyWith(fontWeight: FontWeight.w800); //s12

  static final whiteS22 = white.copyWith(fontSize: 22);
  static final whiteS22Bold = whiteS22.copyWith(fontWeight: FontWeight.w700);
  static final whiteS22W800 =
      whiteS22.copyWith(fontWeight: FontWeight.w800); //s24
...
//s22
  static final greyS22 = grey.copyWith(fontSize: 22);
  static final greyS22Bold = greyS18.copyWith(fontWeight: FontWeight.bold);
  static final greyS22W800 = greyS18.copyWith(fontWeight: FontWeight.w800);
  ...
  //changePassword
  static const changPassword = TextStyle(color: Color(0xffFF4500));
  static final changePasswordColor = changPassword.copyWith(fontSize: 20);
  static final changePasswordBold =
      changPassword.copyWith(fontWeight: FontWeight.w800);
  static final changePasswordW800 =
      changPassword.copyWith(fontWeight: FontWeight.w800);
