...
// import 'package:meas/UI/Login/signin/signin_viewmodel.dart';
...
//                             stream: ListRelativeViewModel.personalIdStream,
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.emailStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.passwordStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.firstNameStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.lastNameStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.phoneNumberStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.roleIdStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.nationalityStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.qualificationStream,
//                             builder: (context, snapshot) {
//                               return createUser(
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.ethnicityStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.languageStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.computerScienceStream,
//                             builder: (context, snapshot) {
//                               return createUser(
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.religionStream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                           stream: ListRelativeViewModel.issueDateStream,
//                           builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                             stream: ListRelativeViewModel.issueBytream,
//                             builder: (context, snapshot) {
...
//                         ),
//                         StreamBuilder<String>(
//                           stream: ListRelativeViewModel.startDateStream,
//                           builder: (context, snapshot) {
...
//                         StreamBuilder<String>(
//                             stream:
//                                 ListRelativeViewModel.permanentAddressStream,
//                             builder: (context, snapshot) {
//                               return createUser(
...
//                   await ListRelativeViewModel.createUser(userData);
...
//     var userViewModel = Provider.of<ListRelativeViewModel>(context);
//     return Scaffold(
